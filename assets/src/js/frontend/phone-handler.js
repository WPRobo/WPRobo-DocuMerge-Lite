    ...
    var WPRoboDocuMerge_Phone = {
        ...
        initPhone: function(input) {
            ...
            var opts = {
                ...
                preferredCountries:    ['gb', 'us', 'ca', 'au', 'de', 'fr', 'in', 'pk', 'ae'],
                ...
                i18n: {},
                utilsScript: (typeof wprobo_documerge_frontend_vars !== 'undefined' && wprobo_documerge_frontend_vars.intl_tel_utils_url)
