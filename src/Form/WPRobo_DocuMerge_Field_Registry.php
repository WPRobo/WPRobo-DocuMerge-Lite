...
use WPRobo\DocuMerge\Form\Fields\WPRobo_DocuMerge_Field_Signature;
use WPRobo\DocuMerge\Form\Fields\WPRobo_DocuMerge_Field_Captcha;
use WPRobo\DocuMerge\Form\Fields\WPRobo_DocuMerge_Field_Payment;
use WPRobo\DocuMerge\Form\Fields\WPRobo_DocuMerge_Field_File_Upload;
use WPRobo\DocuMerge\Form\Fields\WPRobo_DocuMerge_Field_Address;
use WPRobo\DocuMerge\Form\Fields\WPRobo_DocuMerge_Field_Name;
use WPRobo\DocuMerge\Form\Fields\WPRobo_DocuMerge_Field_Hidden;
use WPRobo\DocuMerge\Form\Fields\WPRobo_DocuMerge_Field_Html;
use WPRobo\DocuMerge\Form\Fields\WPRobo_DocuMerge_Field_Section_Divider;
use WPRobo\DocuMerge\Form\Fields\WPRobo_DocuMerge_Field_Password;
use WPRobo\DocuMerge\Form\Fields\WPRobo_DocuMerge_Field_Url;
use WPRobo\DocuMerge\Form\Fields\WPRobo_DocuMerge_Field_Rating;
use WPRobo\DocuMerge\Form\Fields\WPRobo_DocuMerge_Field_Repeater;
...
class WPRobo_DocuMerge_Field_Registry {
	...
	public function wprobo_documerge_register_default_fields() {
		...
		$this->wprobo_documerge_register_field( 'signature', WPRobo_DocuMerge_Field_Signature::class );
		$this->wprobo_documerge_register_field( 'captcha', WPRobo_DocuMerge_Field_Captcha::class );
		$this->wprobo_documerge_register_field( 'payment', WPRobo_DocuMerge_Field_Payment::class );
		$this->wprobo_documerge_register_field( 'file_upload', WPRobo_DocuMerge_Field_File_Upload::class );
		$this->wprobo_documerge_register_field( 'address', WPRobo_DocuMerge_Field_Address::class );
		$this->wprobo_documerge_register_field( 'name', WPRobo_DocuMerge_Field_Name::class );
		$this->wprobo_documerge_register_field( 'hidden', WPRobo_DocuMerge_Field_Hidden::class );
		$this->wprobo_documerge_register_field( 'html', WPRobo_DocuMerge_Field_Html::class );
		$this->wprobo_documerge_register_field( 'section_divider', WPRobo_DocuMerge_Field_Section_Divider::class );
		$this->wprobo_documerge_register_field( 'password', WPRobo_DocuMerge_Field_Password::class );
		$this->wprobo_documerge_register_field( 'url', WPRobo_DocuMerge_Field_Url::class );
		$this->wprobo_documerge_register_field( 'rating', WPRobo_DocuMerge_Field_Rating::class );
		$this->wprobo_documerge_register_field( 'repeater', WPRobo_DocuMerge_Field_Repeater::class );
