    ...
    <?php else : ?>
        ...
        <table class="wdm-table">
            <thead>
                ...
                <tr>
                    <th>
                        <a href="<?php echo esc_url( add_query_arg( array( 'orderby' => 'id', 'order' => ( 'id' === $current_orderby && 'asc' === $current_order ) ? 'desc' : 'asc' ), $base_url ) ); ?>" style="display:inline-flex;align-items:center;gap:2px;">
                    ...
                    <th>
                        <a href="<?php echo esc_url( add_query_arg( array( 'orderby' => 'title', 'order' => ( 'title' === $current_orderby && 'asc' === $current_order ) ? 'desc' : 'asc' ), $base_url ) ); ?>" style="display:inline-flex;align-items:center;gap:2px;">
            ...
            <tbody>
                <?php foreach ( $forms as $form ) : ?>
                    ...
                    $shortcode  = '[documerge_form id="' . absint( $form->id ) . '"]';
                    ?>
                    <tr>
