...
<div class="wdm-page-header">
    ...
    <div class="wdm-page-header-right">
        <?php if ( ! empty( $primary_action ) && is_array( $primary_action ) ) : ?>
            <a href="<?php echo esc_url( $primary_action['url'] ); ?>" class="wdm-btn wdm-btn-primary"<?php if ( ! empty( $primary_action['id'] ) ) : ?> id="<?php echo esc_attr( $primary_action['id'] ); ?>"<?php endif; ?>>
