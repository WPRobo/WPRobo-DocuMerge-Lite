...
<div class="wdm-slide-panel" id="wdm-submission-panel">
	...
	<div class="wdm-slide-panel-header">
		<h2 id="wdm-detail-title"><?php echo esc_html__( 'Submission #0', 'wprobo-documerge' ); ?></h2>
		<button type="button" class="wdm-slide-panel-close" id="wdm-detail-close" aria-label="<?php esc_attr_e( 'Close', 'wprobo-documerge' ); ?>">
