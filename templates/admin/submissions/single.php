	...
	<div class="wdm-page-header">
		<div class="wdm-page-header-left">
			<a href="<?php echo esc_url( admin_url( 'admin.php?page=wprobo-documerge-submissions' ) ); ?>" class="wdm-back-link">
				...
				<?php esc_html_e( 'Back to Submissions', 'wprobo-documerge' ); ?>
			</a>
			<div class="wdm-page-header-text" style="margin-left:12px;">
				<h1 class="wdm-page-title">
					...
					printf(
						...
						esc_html__( 'Submission #%d', 'wprobo-documerge' ),
				...
				<p class="wdm-page-subtitle">
					...
					&mdash; <?php echo esc_html( $submission->form_title ? $submission->form_title : __( 'Unknown Form', 'wprobo-documerge' ) ); ?>
				</p>
			</div>
		</div>
		...
		<div class="wdm-submission-main">
			...
			<div class="wdm-settings-card">
				<div class="wdm-settings-card-header">
					...
					<div>
						<h3><?php esc_html_e( 'Submitted Data', 'wprobo-documerge' ); ?></h3>
						<p><?php esc_html_e( 'All field values from this submission.', 'wprobo-documerge' ); ?></p>
					</div>
				</div>
				<div class="wdm-settings-card-body">
								...
								<tr>
									...
									<td class="wdm-field-value-col">
										<?php if ( is_string( $value ) && strpos( $value, 'data:image/' ) === 0 ) : ?>
											<img src="<?php echo esc_attr( $value ); ?>" alt="<?php esc_attr_e( 'Signature', 'wprobo-documerge' ); ?>" style="max-width:250px;height:auto;border:1px solid #dde5f0;border-radius:6px;padding:8px;background:#fff;">
					...
					<?php else : ?>
						<p class="wdm-text-muted"><?php esc_html_e( 'No field data recorded.', 'wprobo-documerge' ); ?></p>
					<?php endif; ?>
				</div>
			</div>
			...
			<div class="wdm-settings-card">
				<div class="wdm-settings-card-header">
					...
					<div>
						<h3><?php esc_html_e( 'Error Log', 'wprobo-documerge' ); ?></h3>
						<p><?php esc_html_e( 'Error details for this submission.', 'wprobo-documerge' ); ?></p>
					</div>
				</div>
				<div class="wdm-settings-card-body">
			...
			<div class="wdm-settings-card">
				<div class="wdm-settings-card-header">
					...
					<div>
						<h3><?php esc_html_e( 'Admin Notes', 'wprobo-documerge' ); ?></h3>
						<p><?php esc_html_e( 'Internal notes visible only to administrators.', 'wprobo-documerge' ); ?></p>
					</div>
				</div>
				<div class="wdm-settings-card-body">
		...
		<div class="wdm-submission-sidebar">
			...
			<div class="wdm-settings-card">
				<div class="wdm-settings-card-header">
					...
					<div><h3><?php esc_html_e( 'Submission Info', 'wprobo-documerge' ); ?></h3></div>
				</div>
				<div class="wdm-settings-card-body">
					<div class="wdm-meta-list">
						<div class="wdm-meta-item">
							<span class="wdm-meta-label"><?php esc_html_e( 'ID', 'wprobo-documerge' ); ?></span>
							<span class="wdm-meta-value">#<?php echo absint( $submission->id ); ?></span>
						</div>
						<div class="wdm-meta-item">
							<span class="wdm-meta-label"><?php esc_html_e( 'Form', 'wprobo-documerge' ); ?></span>
							<span class="wdm-meta-value"><?php echo esc_html( $submission->form_title ? $submission->form_title : '—' ); ?></span>
						</div>
						<div class="wdm-meta-item">
							<span class="wdm-meta-label"><?php esc_html_e( 'Template', 'wprobo-documerge' ); ?></span>
							<span class="wdm-meta-value"><?php echo esc_html( $submission->template_name ? $submission->template_name : '—' ); ?></span>
						</div>
						<div class="wdm-meta-item">
							<span class="wdm-meta-label"><?php esc_html_e( 'Email', 'wprobo-documerge' ); ?></span>
							<span class="wdm-meta-value"><?php echo esc_html( $submission->submitter_email ? $submission->submitter_email : '—' ); ?></span>
						</div>
						<div class="wdm-meta-item">
							<span class="wdm-meta-label"><?php esc_html_e( 'IP Address', 'wprobo-documerge' ); ?></span>
			...
			<div class="wdm-settings-card">
				<div class="wdm-settings-card-header">
					...
					<div><h3><?php esc_html_e( 'Tracking Data', 'wprobo-documerge' ); ?></h3></div>
				</div>
				<div class="wdm-settings-card-body">
					<div class="wdm-meta-list">
			...
			<div class="wdm-settings-card">
				<div class="wdm-settings-card-body" style="text-align:center;">
					<button type="button" class="wdm-btn wdm-btn-danger wdm-delete-submission-single" data-id="<?php echo absint( $submission->id ); ?>">
						...
						<?php esc_html_e( 'Delete Submission', 'wprobo-documerge' ); ?>
					</button>
				</div>
			</div>
