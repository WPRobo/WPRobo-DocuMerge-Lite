...
<div class="wdm-slide-panel" id="wdm-template-panel">
    ...
    <div class="wdm-slide-panel-header">
        <h2 id="wdm-panel-title"><?php esc_html_e( 'Upload New Template', 'wprobo-documerge' ); ?></h2>
        <button type="button" class="wdm-slide-panel-close" id="wdm-panel-close" aria-label="<?php esc_attr_e( 'Close', 'wprobo-documerge' ); ?>">
    ...
    <div class="wdm-slide-panel-body">
        ...
        <div class="wdm-field-group">
            <label for="wdm-template-name"><?php esc_html_e( 'Template Name', 'wprobo-documerge' ); ?> <span class="wdm-required">*</span></label>
            <input type="text" id="wdm-template-name" class="wdm-input" required placeholder="<?php esc_attr_e( 'e.g. Invoice Template', 'wprobo-documerge' ); ?>">
        </div>

        <!-- Description -->
        <div class="wdm-field-group">
            <label for="wdm-template-description"><?php esc_html_e( 'Description', 'wprobo-documerge' ); ?></label>
            <textarea id="wdm-template-description" class="wdm-textarea" rows="3" placeholder="<?php esc_attr_e( 'Optional description for this template', 'wprobo-documerge' ); ?>"></textarea>
        </div>

        <!-- Upload DOCX -->
        <div class="wdm-field-group">
            <label><?php esc_html_e( 'Upload DOCX File', 'wprobo-documerge' ); ?></label>
            <div class="wdm-dropzone" id="wdm-dropzone">
                <span class="dashicons dashicons-upload"></span>
                <p class="wdm-dropzone-text"><?php esc_html_e( 'Drag & drop your .docx file here, or click to browse', 'wprobo-documerge' ); ?></p>
                <p class="wdm-dropzone-hint"><?php esc_html_e( 'Maximum file size: 10 MB', 'wprobo-documerge' ); ?></p>
        ...
        <div class="wdm-field-group">
            ...
            <div class="wdm-radio-group">
                <label class="wdm-radio-label">
                    ...
                    <?php esc_html_e( 'DOCX', 'wprobo-documerge' ); ?>
                </label>
                <label class="wdm-radio-label">
                    <input type="radio" name="wdm_output_format" value="pdf" checked>
                    <?php esc_html_e( 'PDF', 'wprobo-documerge' ); ?>
                </label>
                <label class="wdm-radio-label">
                    <input type="radio" name="wdm_output_format" value="both">
                    <?php esc_html_e( 'Both', 'wprobo-documerge' ); ?>
                </label>
            </div>
        </div>
        ...
        <div class="wdm-detected-tags wdm-hidden" id="wdm-detected-tags">
            <h3><?php esc_html_e( 'Detected Merge Tags', 'wprobo-documerge' ); ?></h3>
    ...
    <div class="wdm-slide-panel-footer">
        <button type="button" class="wdm-btn" id="wdm-panel-cancel">
            <?php esc_html_e( 'Cancel', 'wprobo-documerge' ); ?>
        </button>
        <button type="button" class="wdm-btn wdm-btn-primary" id="wdm-save-template">
            <?php esc_html_e( 'Save Template', 'wprobo-documerge' ); ?>
        </button>
    </div>
