...
<head>
    ...
    <title><?php esc_html_e( 'DocuMerge Setup', 'wprobo-documerge' ); ?></title>
...
<div class="wdm-wizard-wrap">
    ...
    <div class="wdm-wizard-header">
        <div class="wdm-wizard-logo">
            ...
            <span class="wdm-wizard-logo-text"><?php esc_html_e( 'DocuMerge Setup', 'wprobo-documerge' ); ?></span>
        </div>
    </div>
        ...
        <div class="wdm-wizard-steps-track">
            ...
            <div class="wdm-wizard-step-indicators">
                <div class="wdm-wizard-step-dot wdm-active" data-step="1">
                    ...
                    <span class="wdm-dot-label"><?php esc_html_e( 'Welcome', 'wprobo-documerge' ); ?></span>
                </div>
                <div class="wdm-wizard-step-dot" data-step="2">
                    <span class="wdm-dot-circle"></span>
                    <span class="wdm-dot-label"><?php esc_html_e( 'Detect', 'wprobo-documerge' ); ?></span>
                </div>
                <div class="wdm-wizard-step-dot" data-step="3">
                    <span class="wdm-dot-circle"></span>
                    <span class="wdm-dot-label"><?php esc_html_e( 'Configure', 'wprobo-documerge' ); ?></span>
                </div>
                <div class="wdm-wizard-step-dot" data-step="4">
                    <span class="wdm-dot-circle"></span>
                    <span class="wdm-dot-label"><?php esc_html_e( 'Done', 'wprobo-documerge' ); ?></span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="wdm-wizard-content">
        ...
        <div class="wdm-wizard-step wdm-step-active" data-step="1">
            <div class="wdm-wizard-step-inner">
                ...
                <h2 class="wdm-wizard-title"><?php esc_html_e( 'Welcome to WPRobo DocuMerge', 'wprobo-documerge' ); ?></h2>
                <p class="wdm-wizard-subtitle"><?php esc_html_e( 'Automate your document generation in minutes.', 'wprobo-documerge' ); ?></p>
                <ul class="wdm-wizard-features">
                    <li>
                        <span class="dashicons dashicons-media-document"></span>
                        <?php esc_html_e( 'Upload Word/DOCX templates with merge tags', 'wprobo-documerge' ); ?>
                    </li>
                    <li>
                        <span class="dashicons dashicons-forms"></span>
                        <?php esc_html_e( 'Connect to your existing forms or use our built-in form builder', 'wprobo-documerge' ); ?>
                    </li>
                    <li>
                        <span class="dashicons dashicons-email-alt"></span>
                        <?php esc_html_e( 'Deliver personalised documents automatically on every submission', 'wprobo-documerge' ); ?>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="wdm-wizard-step" data-step="3">
            <div class="wdm-wizard-step-inner">
                <h2 class="wdm-wizard-title"><?php esc_html_e( 'Basic Configuration', 'wprobo-documerge' ); ?></h2>
                <p class="wdm-wizard-subtitle"><?php esc_html_e( 'Set your default preferences. You can change these later in Settings.', 'wprobo-documerge' ); ?></p>

                <div class="wdm-wizard-config-section">
                    <h3 class="wdm-wizard-config-heading"><?php esc_html_e( 'Document Storage', 'wprobo-documerge' ); ?></h3>
                    <div class="wdm-wizard-radio-group">
                        <label class="wdm-wizard-radio">
                            ...
                            <span class="wdm-radio-text"><?php esc_html_e( 'Save generated documents to server (recommended)', 'wprobo-documerge' ); ?></span>
                        </label>
                        <label class="wdm-wizard-radio">
                            <input type="radio" name="wdm_doc_storage" value="delete">
                            <span class="wdm-radio-mark"></span>
                            <span class="wdm-radio-text"><?php esc_html_e( 'Delete after delivery', 'wprobo-documerge' ); ?></span>
                        </label>
                    </div>
                </div>

                <div class="wdm-wizard-config-section">
                    <h3 class="wdm-wizard-config-heading"><?php esc_html_e( 'Default Output Format', 'wprobo-documerge' ); ?></h3>
                    <div class="wdm-wizard-radio-group">
                        <label class="wdm-wizard-radio">
                            <input type="radio" name="wdm_output_format" value="docx">
                            <span class="wdm-radio-mark"></span>
                            <span class="wdm-radio-text"><?php esc_html_e( 'DOCX only', 'wprobo-documerge' ); ?></span>
                        </label>
                        <label class="wdm-wizard-radio">
                            <input type="radio" name="wdm_output_format" value="pdf" checked>
                            <span class="wdm-radio-mark"></span>
                            <span class="wdm-radio-text"><?php esc_html_e( 'PDF only', 'wprobo-documerge' ); ?></span>
                        </label>
                        <label class="wdm-wizard-radio">
                            <input type="radio" name="wdm_output_format" value="both">
                            <span class="wdm-radio-mark"></span>
                            <span class="wdm-radio-text"><?php esc_html_e( 'Both DOCX and PDF', 'wprobo-documerge' ); ?></span>
                        </label>
                    </div>
                </div>

                <div class="wdm-wizard-config-section">
                    <h3 class="wdm-wizard-config-heading"><?php esc_html_e( 'Default Delivery Method', 'wprobo-documerge' ); ?></h3>
                    <div class="wdm-wizard-checkbox-group">
                        <label class="wdm-wizard-checkbox">
                            ...
                            <span class="wdm-checkbox-text"><?php esc_html_e( 'Email to submitter', 'wprobo-documerge' ); ?></span>
                        </label>
                        <label class="wdm-wizard-checkbox">
                            <input type="checkbox" name="wdm_delivery_methods[]" value="download" checked>
                            <span class="wdm-checkbox-mark"></span>
                            <span class="wdm-checkbox-text"><?php esc_html_e( 'Download in browser', 'wprobo-documerge' ); ?></span>
                        </label>
                        <label class="wdm-wizard-checkbox">
                            <input type="checkbox" name="wdm_delivery_methods[]" value="media">
                            <span class="wdm-checkbox-mark"></span>
                            <span class="wdm-checkbox-text"><?php esc_html_e( 'Save to media library', 'wprobo-documerge' ); ?></span>
                        </label>
                    </div>
                </div>
            </div>
        ...
        <div class="wdm-wizard-step" data-step="4">
            <div class="wdm-wizard-step-inner wdm-wizard-done">
                ...
                <h2 class="wdm-wizard-title"><?php esc_html_e( "You're all set!", 'wprobo-documerge' ); ?></h2>
                <p class="wdm-wizard-subtitle"><?php esc_html_e( 'WPRobo DocuMerge is ready to use.', 'wprobo-documerge' ); ?></p>
                <div class="wdm-wizard-done-actions">
                    <a href="<?php echo esc_url( admin_url( 'admin.php?page=wprobo-documerge-templates' ) ); ?>" class="wdm-btn wdm-btn-primary" id="wdm-wizard-go-templates">
                        <?php esc_html_e( 'Upload Your First Template', 'wprobo-documerge' ); ?>
                    </a>
                    <a href="<?php echo esc_url( admin_url( 'admin.php?page=wprobo-documerge' ) ); ?>" class="wdm-btn wdm-btn-secondary" id="wdm-wizard-go-dashboard">
                        <?php esc_html_e( 'Go to Dashboard', 'wprobo-documerge' ); ?>
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="wdm-wizard-footer" id="wdm-wizard-footer">
        <a href="<?php echo esc_url( admin_url( 'admin.php?page=wprobo-documerge' ) ); ?>" class="wdm-wizard-skip" id="wdm-wizard-skip">
            <?php esc_html_e( 'Skip Setup', 'wprobo-documerge' ); ?>
        </a>
        <button type="button" class="wdm-btn wdm-btn-primary" id="wdm-wizard-continue">
            <?php esc_html_e( 'Continue', 'wprobo-documerge' ); ?>
